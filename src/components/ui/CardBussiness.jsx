...
const CardBussiness = ({
  ...
  return (
    <div
      className={`${borderColor} cursor-pointer rounded-lg bg-white p-4 mb-4 relative shadow-lg hover:shadow-xl`}
    >
      {point && (
      ...
      <div className="flex items-center mb-4">
        ...
        />
        <h4 className="text-1xl font-semibold ml-2">{title}</h4>
      </div>
      <p className="text-secondary-400 text-sm">
        In KPCapital we can collect many data, that would help your business to
        find the right capital providers.
      </p>
